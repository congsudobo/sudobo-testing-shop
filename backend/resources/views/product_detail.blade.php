                        ...
                        <div class="product-input">
                            <div class="product-hozi">
                                ...
                                <input style="width: 85%" value="{{old('product_name', $product->product_name ?? '')}}" class="form-control form-control-user" placeholder="Nhập tên sản phẩm" type="text" name="product_name" >
                            </div>
                            <div class="product-hozi">
                                <label style="width: 15%"class="label-product">Số lượng</label>
                                <input style="width: 85%" value="{{old('count', $product->count ?? '')}}" class="form-control form-control-user" placeholder="Nhập số lượng sản phẩm" type="number" name="count" >
                            </div>
                            <div class="product-hozi">
                            ...
                            <div class="product-hozi">
                                ...
                                <input style="width: 85%" value="{{old('added_date', $product->added_date ?? '')}}" class="form-control form-control-user" placeholder="Nhập ngày" type="date" name="added_date" >
                            </div>
                            <div class="product-hozi">
                                <label style="width: 15%" class="label-product">Ngày hết hạn *</label>
                                <input style="width: 85%" value="{{old('expiration_date', $product->expiration_date ?? '')}}" class="form-control form-control-user" placeholder="Nhập ngày" type="date" name="expiration_date" >
                            </div>
                            @isset($product)
